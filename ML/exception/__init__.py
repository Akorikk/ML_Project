...
class CustomException(Exception):
    def __init__(self, error_massage:Exception, error_details: sys):
        self.error_massage = CustomException.get_datailed_error_massage(error_massage = error_massage,
                                                                        error_details = error_details
        )

    @staticmethod
    def get_datailed_error_massage(error_massage:Exception, error_details: sys)->str:
